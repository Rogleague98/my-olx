...
import { User, Mail, Lock, Eye, EyeOff, ArrowRight, Sparkles, Users } from 'lucide-react';
      ...
      <div className="max-w-md w-full mx-auto p-8 glass-strong rounded-3xl shadow-xl border border-blue-700 bg-[#23272f]/80 backdrop-blur-xl text-white animate-fade-in">
        <div className="relative z-10">
          <div className="text-center mb-8">
            <div className="w-20 h-20 bg-gradient-to-r from-secondary-500 to-primary-500 rounded-full mx-auto mb-6 flex items-center justify-center shadow-xl animate-pulse-glow">
              <Users className="w-10 h-10 text-white" />
            </div>
            <h1 className="text-4xl font-bold text-gradient mb-3">Join Our Community</h1>
            <p className="text-white text-lg">Create your account and start selling today</p>
            <div className="flex items-center justify-center gap-2 mt-4">
              <Sparkles className="w-5 h-5 text-accent-500" />
              <span className="text-sm text-white font-medium">Fast & Secure Registration</span>
              <Sparkles className="w-5 h-5 text-accent-500" />
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="relative">
              ...
              <button
                type="button"
                className="absolute right-3 top-1/2 transform -translate-y-1/2 text-white transition-colors p-1 rounded-lg"
